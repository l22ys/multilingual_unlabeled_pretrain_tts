...
# copied from https://github.com/coqui-ai/TTS/blob/dev/TTS/tts/layers/generic/wavenet.py
@torch.jit.script
...
class WN(torch.nn.Module):
    ...
    def forward(self, x, x_mask=None, g=None, **kwargs):  # pylint: disable=unused-argument
        ...
        if g is not None:
            g = self.cond_layer(g) # conv1d
        for i in range(self.num_layers):
            x_in = self.in_layers[i](x) #conv1d
            ...
            res_skip_acts = self.res_skip_layers[i](acts) # conv1d
